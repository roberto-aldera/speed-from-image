...
GOAL_FORCE_MULTIPLIER = 2
OBSTACLE_FORCE_MULTIPLIER = 3
VELOCITY_LIMIT = 2
NOMINAL_VELOCITY = 2
PROXIMITY_TO_OBSTACLE_CAUTION_FACTOR = 5
NUM_POSE_DIMS = 3
...
MAZE_SPEED_MEAN = np.array([0.5779633637025109, -2.268513358267252e-05, -8.668084281236787e-05])
MAZE_SPEED_STD_DEV = np.array([0.4257546321765751, 0.04073399513748616, 0.17892760810747305])
